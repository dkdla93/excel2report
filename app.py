...
def process_data(input_df, creator_info_handler, gmail_api=None, send_email=False,
    ...
    try:
        ...
        for idx, creator_id in enumerate(creator_info_handler.get_all_creator_ids()):
            ...
            if status_container:
                status_text.write(f"진행 상황: {idx + 1}/{total_creators} - {creator_id} 처리 중...")
